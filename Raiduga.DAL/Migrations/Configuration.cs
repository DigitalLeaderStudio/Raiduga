...
//			#endregion
			...
			context.Set<AgeGroup>().AddOrUpdate(ageGroup => ageGroup.Name,
				new AgeGroup
				{
					Name = "1-2 роки",
					Description = "1-2 роки"
				},
				new AgeGroup
				{
					Name = "2-3 роки",
					Description = "2-3 роки"
				},
				new AgeGroup
				{
					Name = "3-4 роки",
					Description = "3-4 роки"
				},
				new AgeGroup
				{
					Name = "4-5 років",
					Description = "4-5 років"
				},
				new AgeGroup
				{
					Name = "5-6 років",
					Description = "5-6 років"
				},
				new AgeGroup
				{
					Name = "інтелектуальні заняття",
					Description = "інтелектуальні заняття"
				},
				new AgeGroup
				{
					Name = "творчі заняття",
					Description = "творчі заняття"
				});
